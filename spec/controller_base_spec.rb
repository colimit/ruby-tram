...
describe ControllerBase do
  ...
  describe "#render" do
    ...
    it "renders the html of the show erb view" do
      users_controller.instance_variable_set(:@favorite_color, "green")
      users_controller.render(:show)
      users_controller.res.body.should include("green")
      users_controller.res.body.should include("<h1>")
      users_controller.res.content_type.should == "text/html"
    end
  end
